...
#include "../../ExtPlane/extplane-server/datarefs/dataref.h"
...
QT_MOC_LITERAL(3, 17, 8), // "DataRef*"
QT_MOC_LITERAL(4, 26, 3) // "ref"

    },
    "DataRef\0changed\0\0DataRef*\0ref"
};
...
void DataRef::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->changed((*reinterpret_cast< DataRef*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        case 0:
            ...
            default: *reinterpret_cast<int*>(_a[0]) = -1; break;
            case 0:
                *reinterpret_cast<int*>(_a[0]) = qRegisterMetaType< DataRef* >(); break;
            }
            break;
        }
...
// SIGNAL 0
void DataRef::changed(DataRef * _t1)
{
