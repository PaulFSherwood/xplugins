...
public:
    ...
    void setupUi(QDialog *PanelItemSelectionDialog)
    {
        if (PanelItemSelectionDialog->objectName().isEmpty())
            PanelItemSelectionDialog->setObjectName(QString::fromUtf8("PanelItemSelectionDialog"));
    ...
    {
        PanelItemSelectionDialog->setWindowTitle(QApplication::translate("PanelItemSelectionDialog", "Add item", nullptr));
    } // retranslateUi
